...
#
# Created by icc2 write_sdc on Mon Jun  2 09:42:00 2025
#
################################################################################
...
# -origin useful_skew
set_clock_latency -min 0.0290871 [get_clocks {Clock}]
# -origin useful_skew
set_clock_latency -max 0.0304413 [get_clocks {Clock}]
...
# /home/student/Documents/RTL2GDSII(1)/RTL2GDSII/CONSTRAINTS/8bit_shifter.sdc, \
#   line 3
set_input_delay -clock [get_clocks {Clock}] -max 0.5 [get_ports {Direction}]
# /home/student/Documents/RTL2GDSII(1)/RTL2GDSII/CONSTRAINTS/8bit_shifter.sdc, \
#   line 3
set_input_delay -clock [get_clocks {Clock}] -max 0.5 [get_ports \
    {Shift_Amount[2]}]
# /home/student/Documents/RTL2GDSII(1)/RTL2GDSII/CONSTRAINTS/8bit_shifter.sdc, \
#   line 3
set_input_delay -clock [get_clocks {Clock}] -max 0.5 [get_ports \
