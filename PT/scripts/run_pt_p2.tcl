...
read_parasitics "./../ICCII/results/8bit_shifter_func::nom.spef.p2_125.spef"
...
report_timing -slack_lesser_than 0.0 -delay max -nosplit -input -net  > ./reports/timing/report_timing.p2_report
